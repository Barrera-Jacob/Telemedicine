...
import com.designskill.telemedicine.adapter.MessageListAdapter;
...
public class MessageActivity extends AppCompatActivity {
    ...
    ArrayList<com.designskill.telemedicine.model.Message> messageArrrayList;
    ...
    MessageListAdapter.onSelectedPlaceListener m_onlistner = new MessageListAdapter.onSelectedPlaceListener() {
        @Override
        public void onClick(com.designskill.telemedicine.model.Message videoDetails) {
    ...
    public void loadMessagestintoListView() {
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                com.designskill.telemedicine.model.Message doctor = new com.designskill.telemedicine.model.Message();
