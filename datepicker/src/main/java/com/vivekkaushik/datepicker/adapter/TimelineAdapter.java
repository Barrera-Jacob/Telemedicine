...
//                    holder.monthView.setTextColor(Color.parseColor("#FFFFFF"));
//                    holder.dateView.setTextColor(Color.parseColor("#FFFFFF"));
//                    holder.dayView.setTextColor(Color.parseColor("#FFFFFF"));
